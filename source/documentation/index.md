...
EORI numbers handled by this API are prefixed either GB or XI, representing Great Britain or Nothern Ireland respectively. Below is a breakdown of the EORI number format for UK/NI VAT-registered businesses. A typical EORI originating in the GB or Northern Ireland is as follows:
